...
final class Version20250416094432 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE article (id SERIAL NOT NULL, url VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(2000) DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
